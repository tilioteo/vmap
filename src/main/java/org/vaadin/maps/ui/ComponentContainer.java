 ...
 * @author Kamil Morong
 */
public interface ComponentContainer<C extends Component>
        extends HasComponents<C>, com.vaadin.ui.HasComponents.ComponentAttachDetachNotifier {
    ...
    void addComponents(C... components);
     ...
     */
    void replaceComponent(C oldComponent, C newComponent);
     ...
     *
     * @param source the container which contains the components that are to be
     *               moved to this container.
     */
    void moveComponentsFrom(ComponentContainer<C> source);
