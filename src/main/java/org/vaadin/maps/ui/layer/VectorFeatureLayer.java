...
public class VectorFeatureLayer extends AbstractLayer<VectorFeatureContainer> implements Focusable {
    ...
    private final VectorFeatureLayerServerRpc rpc = new VectorFeatureLayerServerRpc() {
        /*
     ...
     *
     * @param feature the feature to be added.
     * @param index   the index of the feature position. The features currently in
     *                and after the position are shifted forwards.
     */
    ...
    /**
     * Gets the typed feature container iterator for going through all the
     ...
     * feature overtakes the position of the old feature. If the old feature is
     * not in the layer, the new feature is added to the layer. If the both
     * feature are already in the layer, their positions are swapped. Component
     * attach and detach events should be taken care as with add and remove.
     * </p>
     *
     * @param oldFeature the old feature that will be replaced.
     * @param newFeature the new feature to be replaced.
     */
    ...
    /**
     * Adds the feature container click listener.
     *
