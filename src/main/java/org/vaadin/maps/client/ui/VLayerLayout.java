...
public class VLayerLayout extends ComplexPanel implements PanHandler, ZoomHandler {
    ...
    protected final Map<Widget, LayoutWrapper> widgetLayoutWrappers = new HashMap<>();
     ...
     * @param order The position string
     */
     ...
     *
     * @param widget     The widget which wrapper we want to add the stylenames to
     * @param stylenames The style names that should be added to the wrapper
     */
    ...
    protected class LayoutWrapper {
         ...
         *
         * @param stylenames The wrapper style names
         */
