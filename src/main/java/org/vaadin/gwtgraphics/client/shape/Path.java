...
public class Path extends Shape implements Cloneable {
     ...
     *
     * @param index the index of the PathStep element to set
     * @param step  PathStep to be stored at the specified position
     ...
     * to their indices).
     *
     * @param index index position where to add new Step
     * @param step  new Step
     * @throws IllegalArgumentException
     */
     ...
     *
     * @param index the index of the PathStep element to removed
     */
     ...
     *
     * @param x an absolute x-coordinate in pixels
     * @param y an absolute y-coordinate in pixels
     */
     ...
     *
     * @param x a relative x-coordinate in pixels
     * @param y a relative y-coordinate in pixels
     */
     ...
     *
     * @param redrawIfManual if <code>true</code> path will be redraw even if
