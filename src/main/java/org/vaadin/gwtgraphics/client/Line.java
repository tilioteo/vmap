 ...
 * @author Henri Kerola
 */
public class Line extends AbstractDrawing implements Strokeable, Animatable {
     ...
     *
     * @param x1 the new x-coordinate in pixels
     */
     ...
     *
     * @param y1 the new y-coordinate in pixels
     */
     ...
     *
     * @param x2 the new x-coordinate in pixels
     */
     ...
     * Sets the y-coordinate position of the ending point of Line.
     *
     * @param y2 the new x-coordinate in pixels
     */
