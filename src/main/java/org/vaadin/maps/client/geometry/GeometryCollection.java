...
public class GeometryCollection extends Geometry implements Iterable<Geometry> {
     ...
     */
    protected final LinkedList<Geometry> geometries = new LinkedList<>();
    ...
    /**
     * @param geometries the <code>Geometry</code>s for this
    ...
    public static GeometryCollection clone(GeometryCollection geometryCollection) {
