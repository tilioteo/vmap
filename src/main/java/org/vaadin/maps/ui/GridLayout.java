...
public class GridLayout<C extends Component> extends AbstractLayout<C> implements LayoutClickNotifier<C> {
    ...
    private final GridLayoutServerRpc rpc = new GridLayoutServerRpc() {
     ...
     * @param column1   the column of the upper left corner of the area <code>c</code>
     ...
     *
     * @param column the component's column, starting from 0.
     * @param row    the component's row, starting from 0.
     */
     ...
     *
     * @param row Index of the row before which the new row will be inserted.
     ...
     * </p>
     *
     * @param row Index of the row to remove. The leftmost row has index 0.
     */
