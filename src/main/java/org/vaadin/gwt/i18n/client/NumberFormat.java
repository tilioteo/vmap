...
public abstract class NumberFormat extends Format {
    ...
    public boolean equals(Object other) {
        ...
        return maxFractionDigits == nf.maxFractionDigits && minFractionDigits == nf.minFractionDigits
                && maxIntegerDigits == nf.maxIntegerDigits && minIntegerDigits == nf.minIntegerDigits
                && groupingUsed == nf.groupingUsed && integerOnly == nf.integerOnly;
    }
    ...
    @Override
    public int hashCode() {
        return maxFractionDigits * 2 + minFractionDigits * 3 + maxIntegerDigits * 5 + minIntegerDigits * 7
                + (groupingUsed ? 11 : 0) + (integerOnly ? 13 : 0);
    }
